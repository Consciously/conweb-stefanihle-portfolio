...
export const HeaderHome = () => {
	...
	return (
		...
		>
			...
			<Navbar collapseOnSelect expand='md' bg='transparent' variant='dark' sticky='top'>
			...
			<Container>
				<Row className='flex-column justify-content-center align-items-center fill'>
					<div className='headline text-light text-center'>
						<h1>Stefan Ihle</h1>

						<p className='lead'>
							Hi! I’m a thrived and passionated{' '}
							<span className='text-danger'>web</span> developer
						</p>
